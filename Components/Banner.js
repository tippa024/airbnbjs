...
function Banner() {
    return (
        <div className="relative h-[300px] sm:h-[400px] lg:h-[550px] xl:h-[850px] 2xl:h-[1250px]">
            <Image src="https:links.papareact.com/0fm" layout="fill" objectFit="cover" style={{ objectPosition: 'center' }} alt="BannerImage" />
